Create one horizontal four-cardinal anchor strip for Codex pet `spanky-s-huhbeast`.
...
Repair emphasis for retry: keep each of the four cardinal poses smaller and centered with generous magenta padding inside its slot. No ear, tail, paw, tooth, jaw, or body pixel may approach or touch a slot boundary. Preserve direction semantics and identity, but reduce pose size slightly if needed to avoid all edge contact.
