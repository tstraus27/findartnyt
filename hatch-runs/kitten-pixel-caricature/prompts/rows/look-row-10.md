Create one horizontal look-direction strip for Codex pet `kitten`, atlas row 10.
...
Pointer behavior note: this row continues hover/pointer engagement. Each direction should look like Kitten is hissing or about to bite toward that direction: narrowed green eyes, pinned/flared ears, black lips pulled back, massive underbite and lower teeth visible, one paw ready to swat. Preserve cute pixel-sprite caricature style.

Critical repair note: the previous generated row failed blind direction QA because the 270 screen-left cardinal and the leftward/intermediate poses still read as screen-right. In this replacement row, all poses after 180 must visibly turn toward screen-left. The nose tip, orange nose, black lips, lower canine, muzzle, pupils, and swatting paw must move to the screen-left side of the head/body for 202.5, 225, 247.5, 270, 292.5, 315, and 337.5. At 270, the face must unmistakably aim toward the viewer's LEFT edge, opposite the 090 right cardinal. Do not reuse a right-facing pose or mirror incorrectly.
